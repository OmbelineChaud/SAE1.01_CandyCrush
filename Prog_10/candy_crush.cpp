...
int main() {
    ...
    while(nbCout > 0){
        cout << "votre score : " << score << " coups restant : " <<nbCout << endl;
        displayGrid(grid, colors); 
        ...
        while (atLeastThreeInAColumn(grid, pos, howMany)){
            ...
            cout << "Match en colonne! + " << howMany << " points." << endl;
            cout << "votre score : " << score << " coups restants : " <<nbCout << endl;
            displayGrid(grid, colors); 
        }
        ...
        while (atLeastThreeInARow(grid, pos, howMany))
        {
            ...
            score = score+howMany;
            applyGravity(grid);
            cout << "Match en ligne! + " << howMany << " points." << endl;
            cout << "votre score : " << score << " coups restant : " <<nbCout << endl;
            displayGrid(grid, colors); 
        }
